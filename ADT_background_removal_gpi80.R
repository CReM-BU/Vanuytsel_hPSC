...
cd34pkeep <- fread("./Data/gpi80_cell_list_7235.csv")
cd34pkeep <- tstrsplit(cd34pkeep[[1]], "_")[[1]]

#ADT
hscdt <- readMM("./Data/GM-KV_CD34P-GPI80P-mRNA/raw.data/antibody/matrix.mtx.gz")
rn <- fread("./Data/GM-KV_CD34P-GPI80P-mRNA/raw.data/antibody/features.tsv.gz",
    header = FALSE)
cn <- fread("./Data/GM-KV_CD34P-GPI80P-mRNA/raw.data/antibody/barcodes.tsv.gz",
    header = FALSE)
colnames(hscdt) <- cn[[1]]
rownames(hscdt) <- rn[[1]]
...
cd34pmouse <- readRDS("./Data/GM-KV_CD34P-GPI80P-mRNA_mouse.cells.Rds")
...
pdf("gpi80_adt_background_cutoff_byrow_bw015.pdf")
print(g0.5)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_bw015_w10.pdf", width = 10)
print(g0.5)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_ylim3_bw015.pdf")
print(g1)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_ylim3_bw015_w10.pdf",
    width = 10)
print(g1)
dev.off()
...
pdf("gpi80_adt_background_cutoff_byrow_bw015_selected.pdf")
print(g2)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_bw015_selected_w10.pdf", width = 10)
print(g2)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_ylim3_bw015_selected.pdf")
print(g3)
dev.off()

pdf("gpi80_adt_background_cutoff_byrow_ylim3_bw015_selected_w10.pdf",
    width = 10)
print(g3)
dev.off()
...
fwrite(as.data.table(cd34pcoh, keep.rownames = TRUE),
   file = "gpi80_7235cells_ADT_CLR_subtracted.csv")
